...
def main():
    ...
    write_df = write_df.sort_values(by='percent_total_market', ascending=False)
    biggest_cap_coin = write_df['name'][0]
    print(f'the cryptocurrency with the biggest market cap today is: {biggest_cap_coin}')
